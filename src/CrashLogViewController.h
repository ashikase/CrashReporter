...
CrashLogViewController.h ... Non-word-wrapped text viewer.
...
@interface CrashLogViewController : UIViewController {
	IncludeReporterLine* reporter;
	UIWebView* webView;
//	UIBarButtonItem* left, *right, *stop, *refresh, *copy;
}
@property(retain,nonatomic) IncludeReporterLine* reporter;
